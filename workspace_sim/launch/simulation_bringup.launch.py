...
def launch_setup(context, *args, **kwargs):
    ...
    object_detecton_launch_descreption = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
    ...
    nodes_to_start = [
        ...
        moveit_rviz_launch_description,
        object_detecton_launch_descreption
    ]
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_file",
            default_value=PathJoinSubstitution(
                [FindPackageShare("workspace_sim"), "urdf", "robot_arm.urdf.xacro"]
            ),
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "world_file",
            default_value=PathJoinSubstitution(
                [FindPackageShare("workspace_sim"), "worlds", "workspace_world.sdf"]
            ),
